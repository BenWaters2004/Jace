...
class DevicePairing(Base):
    ...
    pairing_code_hash: Mapped[str] = mapped_column(
        String(64),
        nullable=False,
        unique=True,
        index=True,
    )
    requested_name: Mapped[str | None] = mapped_column(
        String(160),
        nullable=True,
    )
    requested_by_client_id: Mapped[str | None] = mapped_column(
        String(160),
        nullable=True,
    )
...
# JACE_4BS6_DEVICE_CAPABILITY_MODEL
class DeviceCapabilityRequest(Base):
    __tablename__ = "device_capability_requests"
    ...
    approval_json: Mapped[str] = mapped_column(
        Text,
        nullable=False,
        default="{}",
    )
...
class ProcessRun(Base):
    ...
    command_preview: Mapped[str] = mapped_column(
        Text,
        nullable=False,
    )
    ...
    output_truncated: Mapped[int] = mapped_column(
        Integer,
        nullable=False,
        default=0,
    )
    last_agent_sequence: Mapped[int] = mapped_column(
        Integer,
        nullable=False,
        default=0,
    )
...
class ProcessOutputChunk(Base):
    __tablename__ = "process_output_chunks"
    ...
    agent_sequence: Mapped[int] = mapped_column(
        Integer,
        nullable=False,
        index=True,
    )
...
class TerminalOutputChunk(Base):
    __tablename__ = "terminal_output_chunks"

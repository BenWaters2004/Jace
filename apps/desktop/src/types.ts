...
export interface ConnectionProvider {
  ...
  description: string;
  auth_kind: string;
  setup_state: "available" | "oauth_pending";
...
export type OAuthFlowKind = "authorization_code_pkce" | "device_code";
...
export interface OAuthClientConfig {
  ...
  client_secret_supported: boolean;
  tenant: string | null;
  tenant_supported: boolean;
  flow_kind: OAuthFlowKind;
  redirect_uri: string | null;
  scopes: string[];
}
export interface OAuthClientConfigListResponse { configs: OAuthClientConfig[]; }
export interface OAuthClientConfigUpdateRequest {
  client_id: string;
